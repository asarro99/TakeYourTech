...
<%
	...
	if(sidemenu == null) {
		response.sendRedirect("./Product?page=/assistito.jsp");	
		return;
	}
%>
<!DOCTYPE html>
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="./css/assistito.css" />
      <link
         rel="stylesheet"
   ...
   <body>
      ...
      <div class="selection_copy">
        <h4>Selezione componenti</h4>
      </div>
      <div class="container text-center">
        <div class="row">
          <div class="col-md-4">
            <h1 class="h1sel">Scheda Madre</h1>
          </div>
          <div class="col-md-4">
            <h1 class="h1sel">CPU</h1>
          </div>
          <div class="col-md-4">
            <h1 class="h1sel">GPU</h1>
          </div>
          <div class="col-md-4">
            <h1 class="h1sel">RAM</h1>
          </div>
          <div class="col-md-4">
            <h1 class="h1sel">SSD</h1>
          </div>
          <div class="col-md-4">
            <h1 class="h1sel">HDD</h1>
          </div>
        </div>
      </div>
    </section>
